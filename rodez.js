...
//cercles ligne 1 
$(" .Cerc1_lign_1, .Cerc2_lign_1, .Cerc3_lign_1, .Cerc4_lign_1, .Cerc1_lign_2, .Cerc2_lign_2, .Cerc3_lign_2, .Cerc4_lign_2, .Cerc1_lign_3, .Cerc2_lign_3, .Cerc3_lign_3, .Cerc4_lign_3, .Cerc1_lign_4, .Cerc2_lign_4, .Cerc3_lign_4, .Cerc4_lign_4, .Cerc1_lign_5, .Cerc2_lign_5, .Cerc3_lign_5, .Cerc4_lign_5").click(function() {
  /*if ($(this).hasClass("active"))
    {
      $(this).removeClass("active");
    }
...
$('.Car_lign_1').click(function() {
  $('.Car_lign_1, .Cerc1_lign_1, .Cerc2_lign_1, .Cerc3_lign_1, .Cerc4_lign_1').each(function() {
    $(this).toggleClass("active");
  });
});
//carré ligne 2
